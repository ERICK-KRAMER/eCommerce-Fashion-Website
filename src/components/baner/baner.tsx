const Baner = () => {
  return (
    <div className="h-[600px] max-sm:h-[300px] bg-baner bg-cover text-white relative">
      <div className="absolute right-40 top-40 max-sm:right-0 max-sm:top-10 w-[400px] flex justify-center gap-6 items-start flex-col">
